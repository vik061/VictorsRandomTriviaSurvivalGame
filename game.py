...
def make_hard_board_coordinates(rows: int, columns: int) -> dict[tuple[int, int], str]:
    ...
    """
    hard_board_dictionary = {(row_coordinate, column_coordinate): "Hard" for row_coordinate in range(rows)
                             for column_coordinate in range(columns)
...
def make_final_boss_board_coordinate(rows: int, columns: int) -> dict[tuple[int, int], str]:
    ...
    {(4, 4): 'Final Boss'}
    """
    final_boss_board_dictionary = {(row_coordinate, column_coordinate): "Final Boss" for row_coordinate in range(rows)
                                   for column_coordinate in range(columns) if row_coordinate == 4 and
                                   column_coordinate == 4}
